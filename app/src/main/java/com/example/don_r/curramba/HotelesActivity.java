...
public class HotelesActivity extends AppCompatActivity {
     ...
     */
    private ViewPager mViewPager; //permite colocar los fragmentos y hacer desplazamientos a los lados
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public Fragment getItem(int position) {//recibe posicion y retorna un fragmento
